...
## Personal Notes (from Rachel)

Important Caveats

- Front-end code is not going to be executed in the browser
  - Things like the global `window` and `document` variables aren't accessible
